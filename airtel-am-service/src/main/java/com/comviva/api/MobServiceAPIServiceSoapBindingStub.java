...
public class MobServiceAPIServiceSoapBindingStub extends org.apache.axis.client.Stub implements com.comviva.api.MobServiceAPI {
    ...
    private static void _initOperationDesc1(){
        ...
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://api.comviva.com", "modificationRequest"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://services.comviva.com", "ModificationRequest"), com.comviva.services.ModificationRequest.class, false, false);
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("http://services.comviva.com", "modificationReturn"));
        oper.setReturnClass(com.comviva.services.ModificationReturn.class);
        ...
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://api.comviva.com", "registrationRequest"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://services.comviva.com", "RegistrationRequest"), com.comviva.services.RegistrationRequest.class, false, false);
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("http://services.comviva.com", "registrationReturn"));
        oper.setReturnClass(com.comviva.services.RegistrationReturn.class);
    ...
    public MobServiceAPIServiceSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            cls = com.comviva.services.ModificationRequest.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("http://services.comviva.com", "modificationReturn");
            cachedSerQNames.add(qName);
            cls = com.comviva.services.ModificationReturn.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = com.comviva.services.RegistrationRequest.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("http://services.comviva.com", "registrationReturn");
            cachedSerQNames.add(qName);
            cls = com.comviva.services.RegistrationReturn.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {modificationRequest});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            try {
                return (com.comviva.services.ModificationReturn) _resp;
            } catch (java.lang.Exception _exception) {
                return (com.comviva.services.ModificationReturn) org.apache.axis.utils.JavaUtils.convert(_resp, com.comviva.services.ModificationReturn.class);
            }
        }
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {registrationRequest});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            extractAttachments(_call);
            try {
                com.comviva.services.RegistrationReturn resp = (com.comviva.services.RegistrationReturn) _resp;
                resp.set_call(_call);
                return (com.comviva.services.RegistrationReturn) resp;
            } catch (java.lang.Exception _exception) {
            	com.comviva.services.RegistrationReturn resp = (com.comviva.services.RegistrationReturn) _resp;
                resp.set_call(_call);
                return (com.comviva.services.RegistrationReturn) resp;  }
