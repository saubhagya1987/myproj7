...
@NamedQueries({
	@NamedQuery(name = "ClientOauthDetails.findByClientId", query = " Select c from ClientOauthDetails c where client_id=:client_id "),
	
})
public class ClientOauthDetails extends BaseEntity implements Serializable {
	...
	@Column(name = "autoapprove", length = 5)
