...
{  
    ...
    public static void main(String[] args) throws Exception
    {
    	...
    	Crypto.AES aes = new Crypto().new AES();
    	final String secretKey = "Secret Passphrase";
        String plainText = "{\"password\":\"1234\"}";
//        String plainText = {"password":"1234"};
        ...
        String ciphertext="";
