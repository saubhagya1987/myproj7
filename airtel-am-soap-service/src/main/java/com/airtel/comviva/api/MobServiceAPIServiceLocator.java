...
public class MobServiceAPIServiceLocator extends org.apache.axis.client.Service implements com.airtel.comviva.api.MobServiceAPIService {
    ...
    private java.lang.String MobServiceAPIPort_address = "http://172.26.162.100:7550/MobServiceAPI/services/MobServiceAPI";
    ...
    public com.airtel.comviva.api.MobServiceAPI getMobServiceAPIPort() throws javax.xml.rpc.ServiceException {
    ...
    public com.airtel.comviva.api.MobServiceAPI getMobServiceAPIPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.airtel.comviva.api.MobServiceAPIServiceSoapBindingStub _stub = new com.airtel.comviva.api.MobServiceAPIServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.airtel.comviva.api.MobServiceAPI.class.isAssignableFrom(serviceEndpointInterface)) {
                com.airtel.comviva.api.MobServiceAPIServiceSoapBindingStub _stub = new com.airtel.comviva.api.MobServiceAPIServiceSoapBindingStub(new java.net.URL(MobServiceAPIPort_address), this);
                _stub.setPortName(getMobServiceAPIPortWSDDServiceName());
                return _stub;
            }
        }
