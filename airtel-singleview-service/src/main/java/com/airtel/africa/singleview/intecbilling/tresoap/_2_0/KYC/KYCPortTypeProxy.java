...
public class KYCPortTypeProxy implements com.airtel.africa.singleview.intecbilling.tresoap._2_0.KYC.KYCPortType {
  private String _endpoint = null;
  private com.airtel.africa.singleview.intecbilling.tresoap._2_0.KYC.KYCPortType kYCPortType = null;
  ...
  private void _initKYCPortTypeProxy() {
    try {
      kYCPortType = (new com.airtel.africa.singleview.intecbilling.tresoap._2_0.KYC.KYCLocator()).getKYCHttpSoap11Endpoint();
      if (kYCPortType != null) {
        if (_endpoint != null)
  ...
  public com.airtel.africa.singleview.intecbilling.tresoap._2_0.KYC.KYCPortType getKYCPortType() {
    if (kYCPortType == null)
      _initKYCPortTypeProxy();
    return kYCPortType;
  }
