...
public class SingleviewException extends Exception {
	...
	public SingleviewException() {
		super();
	}

	public SingleviewException(String message) {
		super(message);
	}

	public SingleviewException(SingleviewExceptionCodes exceptionCodes) {
